...
public class ReqTest {
    ...
    public void whenEmptyRequestThenException() {
        String content = null;
        Req.of(content);
    }

    @Test(expected =  IllegalArgumentException.class)
    public void whenNoGETAndPOST() {
        String ls = System.lineSeparator();
        String content = "/topic/weather/client407 HTTP/1.1" + ls
                + "Host: localhost:9000" + ls
                + "User-Agent: curl/7.72.0" + ls
                + "Accept: */*" + ls + ls + ls;
        Req req = Req.of(content);
    ...
    @Test(expected =  IllegalArgumentException.class)
    public void whenGETWithoutSource() {
        String ls = System.lineSeparator();
        String content = "GET /popic/weather/client407 HTTP/1.1" + ls
                + "Host: localhost:9000" + ls
                + "User-Agent: curl/7.72.0" + ls
                + "Accept: */*" + ls + ls + ls;
        Req req = Req.of(content);
    ...
    @Test(expected =  IllegalArgumentException.class)
    public void whenGETWithWrongPoohMode() {
        String ls = System.lineSeparator();
        String content = "GET /topic HTTP/1.1" + ls
                + "Host: localhost:9000" + ls
                + "User-Agent: curl/7.72.0" + ls
                + "Accept: */*" + ls + ls + ls;
        Req req = Req.of(content);
